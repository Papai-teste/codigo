...
module.exports = function (app) {
  /*
    #swagger.path = '/v1/consentimento/revogar/{idConsentimento}'
    #swagger.parameters['idConsentimento'] = { 
        in: 'path',
        description: "ID do consentimento a ser revogado",
        required: true
    }
    ...
    #swagger.responses[204] = { description: 'Consentimento revogado.' }
